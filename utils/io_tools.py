...
from .metranet_lookup import METRANET_RR_8BIT
...
def arr_compress_uint8(
    ...
    **kwargs
    ...
    if use_metranet_lut:
        ...
        rounded = np.searchsorted(METRANET_RR_8BIT, float_arr)
...
def _write_hdf5_data_to(
    data: np.ndarray, archive_path: str, data_locations: list
) -> None:
    """
...
def load_at_timestamp(
    path: str, timestamp: str, prediction: bool = True, leadtimes: list = None
) -> np.ndarray:
    """
